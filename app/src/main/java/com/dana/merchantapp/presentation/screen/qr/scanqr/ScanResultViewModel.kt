...
@HiltViewModel
class ScanResultViewModel @Inject constructor(private val qrUseCase: QRUseCase) : ViewModel() {
    ...
    fun transaction(amount: Int, payerId: String, timestamp: Long, trxType: String) {
        qrUseCase.transaction(amount, payerId, timestamp, trxType) { isSuccess->
